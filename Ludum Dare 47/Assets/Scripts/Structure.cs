...
public class Structure : MonoBehaviour
{
    ...
    public virtual void Destroy()
    {
        foreach (Cable c in connectedCables)
        {
            ...
            if (GameManager.gm.GetNode(c.pos0) == this)
                partener = GameManager.gm.GetNode(c.pos1);
            else if (GameManager.gm.GetNode(c.pos1) == this)
                partener = GameManager.gm.GetNode(c.pos0);
